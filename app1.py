...
model = pickle.load(open(r"C:\Users\K anusree\OneDrive\Desktop\frontend\linear_regression_model.pkl" , 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Kesagoni Anusree")